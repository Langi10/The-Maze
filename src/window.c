...
/**
 * Initialize the window for displaying the maze.
...
bool initializeWindow(void)
{
    ...
    /* Allocate memory to store color buffer data */
    colorBuffer = malloc(sizeof(color_t) * SCREEN_WIDTH * SCREEN_HEIGHT);

    /* Create an SDL_Texture for displaying the color buffer */
...
/**
 * Clean up and destroy the window when the game is over.
 *
*/
...
/**
 * Clear the color buffer for each frame.
...
/**
 * Render the color buffer for each frame.
 *
*/
 ...
 * @color: Color to assign to the pixel.
*/
